...
private:
	...
	QImage* img = nullptr;
	uchar* data = nullptr; //смерник на даты которые уложены в QImage, дл€ быстрого доступа к пиксел€м
...
public:
	...
	QImage* getImage() { return img; }; //дл€ рисовани€ на виджете
	bool isEmpty();
	...
	bool isInside(int x, int y); //ѕроверка на вхождение координат в границы изображени€
